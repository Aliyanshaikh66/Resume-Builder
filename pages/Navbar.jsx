  ...
  return (
    <div className="">
      <nav className="flex px-2 h-[100px] justify-around py-5 bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
        ...
        <a href="http://localhost:3002/"><button type="button" className="text-white w-[170px] mr-5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-4 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Go to analyzer</button></a>
      </nav>
    </div>
  )
}
